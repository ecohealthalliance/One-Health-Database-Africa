...
write.csv(full_data_combined, "Output/full_data_combined.csv", row.names = F)
write.csv(full_data_number, "Output/full_data_number.csv", row.names = F)
write.csv(full_data_factor, "Output/full_data_factor.csv", row.names = F)
