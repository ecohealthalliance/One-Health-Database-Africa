## creates a csv with appropriate descriptive metadata
## uses deposits package
...
hdx_gheri$Source <- read_csv("meta_data_sources.csv")
...
countries_string <- paste(country_list$CountryName,collapse = ", ")
...
hdx_gheri$`Define Methodology` <- "See publication DOI"
